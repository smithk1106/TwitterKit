...
- (nullable NSString *)mediaIDFromResponseData:(NSData *)data error:(__strong NSError **)error
{
    NSString *mediaID;
    ...
    NSDictionary *json = [NSJSONSerialization JSONObjectWithData:data options:0 error:&return_error];
    error = &return_error;
    if (json) {
...
- (NSURLRequest *)URLRequestWithMethod:(NSString *)method URLString:(NSString *)URLString parameters:(NSDictionary *)parameters error:(__strong NSError **)error
{
...
- (NSURLRequest *)URLRequestWithMethod:(NSString *)method withURL:(NSURL *)URL parameters:(NSDictionary *)parameters error:(__strong NSError **)error
{

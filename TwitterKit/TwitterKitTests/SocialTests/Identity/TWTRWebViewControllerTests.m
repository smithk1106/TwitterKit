...
{
    [super setUp];
    TWTRWebViewControllerShouldLoadCompletion shouldLoadCompletion = ^BOOL(UIViewController *controller, NSURLRequest *urlRequest, WKNavigationAction * navigationAction) {
        return YES;
    };
